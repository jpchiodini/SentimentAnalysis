import scrapy
from DmozItem import FinanceCrawlerItem
...
class BWSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        item['date'] = response.xpath('//meta[@content][@name="parsely-pub-date"]/@content').extract()
        item['keywords'] = response.xpath('//meta[@content][@name="keywords"]/@content').extract() 
        item['body'] = response.xpath('//div[@class = "article-body__content"]/p/text()').extract()
